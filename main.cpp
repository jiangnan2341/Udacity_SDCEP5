...
int main ()
{
  ...
  **/
  ...
  pid_throttle.Init(0.25, 0.0, 0.12, 1.0, -1.0);
...
//           error_steer = 0;
          ...
          //double current_yaw = angle_between_points(x_position, y_position, x_points[x_points.size()-1], y_points[y_points.size()-1]); //use angle between current position and last point in trajectory         
          double current_yaw = angle_between_points(x_position, y_position, x_points[closest_point_idx], y_points[closest_point_idx]); //use angle between current position and closest point in trajectory
...
//           // Update the delta time with the previous command
          ...
          **/
          ...
          //error_throttle = 0;
          //error_throttle = v_points.back() - velocity;  //uses velocity of the last point in trajectory     
          error_throttle = v_points[closest_point_idx] - velocity; //uses velocity of the closest point in trajectory
